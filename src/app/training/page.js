  ...
  return (
    <div className="w-full px-4 pb-24 flex flex-col items-center min-h-screen">
      ...
      <div className="bg-black/80 backdrop-blur-md border border-gray-700 rounded-2xl p-8 shadow-[0_0_25px_rgba(0,255,150,0.2)] w-full max-w-2xl mt-10">
        ...
        <select className="w-full h-16 px-5 text-xl rounded-2xl bg-gray-900 border border-gray-700 text-white mt-2 mb-6">
        ...
        {/* Button */}
        <button className="w-full h-16 text-2xl font-bold rounded-2xl bg-[#00ff9d] text-black shadow-[0_0_20px_rgba(0,255,150,0.6)] hover:bg-purple-500 hover:text-white transition">
          Speichern
        </button>
